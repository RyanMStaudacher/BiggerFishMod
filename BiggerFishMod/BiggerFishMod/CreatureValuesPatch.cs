...
namespace BiggerFishMod
{
    ...
    internal class CreatureValuesPatch
    {
        ...
        public static void InitializeCreatureBaseValues(Creature __instance)
        {
            ...
            {
                MyModOptions.skyRayBaseHealth = ModPlugin.biggerFishSettingsConfig.Bind("Skyray Values", "Skyray Base Health", skyRay.liveMixin.health);
                MyModOptions.skyRayBaseMaxAcceleration = ModPlugin.biggerFishSettingsConfig.Bind("Skyray Values", "Skyray Base Max Acceleration", skyRay.GetComponent<Locomotion>().maxAcceleration);
                MyModOptions.skyRayBaseUpRotationSpeed = ModPlugin.biggerFishSettingsConfig.Bind("Skyray Values", "Skyray Base Up Rotation Speed", skyRay.GetComponent<Locomotion>().upRotationSpeed);
                MyModOptions.skyRayBaseForwardRotationSpeed = ModPlugin.biggerFishSettingsConfig.Bind("Skyray Values", "Skyray Base Forward Rotation Speed", skyRay.GetComponent<Locomotion>().forwardRotationSpeed);
                MyModOptions.skyRayBaseTraitsAnimatorSpeed = ModPlugin.biggerFishSettingsConfig.Bind("Skyray Values", "Skyray Base Traits Animator Speed", skyRay.GetComponent<Skyray>().traitsAnimator.speed);
            }
